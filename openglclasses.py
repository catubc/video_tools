...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def mousePressEvent(self, event):
        ...
        if buttons == QtCore.Qt.MiddleButton:                   #*****************MIDDLE BUTTON SELECTS POINTS UNDER CURSOR***********
...
def plot_3D(self):
    ...
    #Load data as points
    #glwindow.glWidget.points_pyramids = []
    #glwindow.glWidget.colours_pyramids = []
    ##glwindow.glWidget.points_pyramids, glwindow.glWidget.colours_pyramids = points_to_triangles(data)
